// myPod
// $Id: AboutAction.java,v 1.4 2004/08/18 21:29:16 woooo Exp $
//
		...
		SwingWorker worker = new SwingWorker()
		{
			public Object construct()
			{
				...
				try
				{
					...
					aboutDialog.totalDurationContentLabel.setText( GuiUtils.formatTime( myPod.getBackend().getClipsTotalTime() ) 
																													+ " (hh:mm:ss)");
