					...
					do
					{
						...
						if( !iPodFound )
						{
							...
							result = JOptionPane.showOptionDialog(	null,
																											GuiUtils.getStringLocalized("makeIPodAvailableAsDrive"),
					...
					if( iPodFound )
					{
						...
						if( spaceLeft < 0 )
						{
							JOptionPane.showMessageDialog( null,
																							GuiUtils.getStringLocalized("notEnoughSpaceOnIPod")
																							+ " ( " + GuiUtils.formatFilesize(spaceLeft) + " )",
																							GuiUtils.getStringLocalized("couldNotSynchronize"), 
