		...
		try
		{
			...
			do
			{
				...
				if( !iPodFound )
				{
					...
					result = JOptionPane.showOptionDialog( null, GuiUtils.getStringLocalized("makeIPodAvailableAsDrive"),
																									GuiUtils.getStringLocalized("iPodNotAvailable"),
			...
			if( iPodFound )
			{
				...
				int confirmation = JOptionPane.showConfirmDialog( null,
																			GuiUtils.getStringLocalized("doYouReallyWantToDeleteAllSongsAndPlaylistsFromYourIPod?"),
																			GuiUtils.getStringLocalized("confirmDeleteAction"), JOptionPane.YES_NO_OPTION );
