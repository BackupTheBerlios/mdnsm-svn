// myPod
// $Id: myPod.java,v 1.5 2005/02/16 02:12:47 gjuggler Exp $
//
...
import de.axelwernicke.mypod.actions.*;
...
public class myPod
{
	...
	public static void updateClipsTableModel( Playlist playlist )
	{
		if( frontend != null && frontend.getClipsTableView() != null )
		{
			...
			if( colModel != null ) { colModel.storeColumnPreferences(); }
			if( tableModel != null ) { sortingColumns.addAll( tableModel.getSortingColumns() ); }
			...
			if(colModel != null) { colModel.restoreColumnPreferences(); }
