...
public class BasicPlayer implements BasicController, Runnable
{
				...
				{				
					...
					if (m_audioInputStream != null)
					{
						 while (totalSkipped < bytes-SKIP_INACCURACY_SIZE)
                                                {
                                                    skipped = m_encodedaudioInputStream.skip(bytes-totalSkipped);
                                                ...
                                                m_audioInputStream = AudioSystem.getAudioInputStream(targetFormat, m_encodedaudioInputStream);
					}
				}			
	...
	{
	  if  (m_gainControl == null && m_line != null)
	  {
