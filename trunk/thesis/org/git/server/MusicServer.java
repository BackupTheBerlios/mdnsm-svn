 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public final class MusicServer extends BasicStatusObject implements DaapAuthenticator, DaapStreamSource, DaapFilter{
	
    public static final int STATUS_NOT_RUNNING = 0;
    public static final int STATUS_RUNNING = 1;
    
    private static final MusicServer INSTANCE = new MusicServer();
...
//      id2path = new Hashtable();
  	...
  	public synchronized void stop() {
  	    ...
  	    setStatus(MusicServer.STATUS_NOT_RUNNING);
  	}
